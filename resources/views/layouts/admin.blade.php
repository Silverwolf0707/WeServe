...
{{-- Zero-flash sidebar state: runs synchronously before first paint --}}
<script>
  (function () {
...
{{-- =====================================================
     Persistent sidebar state: save on every toggle click.
     The initial state is already applied by the inline script
     directly after <body>, before the first paint.
     ===================================================== --}}
<script>
(function () {
