...
@if (session('toast'))
    ...
    <div class="position-fixed bottom-0 end-0 p-3" style="z-index: 1055">
        <div id="liveToast" class="toast {{ $bgClass }} hide" role="alert" aria-live="assertive"
            aria-atomic="true">
    ...
    <script>
        $(document).ready(function() {
            $('.suggested-amount').on('click', function() {
                ...
                $('#amount').val(value); // Set the input with id="amount"
            });
        });
    </script>
    <style>
                    ...
                    },
                    {
                        ...
                        buttons: [{
                            ...
                            },
                            {
                                extend: 'print',
                                className: 'dt-button dropdown-item d-flex align-items-center gap-2',
                                text: '<i class="fas fa-print text-secondary"></i> ' +
                                    printButtonTrans,
                                exportOptions: {
                                    columns: ':visible:not(:first-child):not(:last-child)'
                                }
                            },
                            {
                                extend: 'colvis',
                                className: 'dt-button dropdown-item d-flex align-items-center gap-2',
                                text: '<i class="fas fa-columns text-warning"></i> ' +
                                    colvisButtonTrans,
                                exportOptions: {
                                    columns: ':visible'
                                }
