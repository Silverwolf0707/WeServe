...
.select2-container--default.select2-container--focus .select2-selection--multiple {
    border-color: var(--pr-forest-mid) !important; box-shadow: 0 0 0 3px rgba(6,78,59,.11) !important;
}
...
.pr-perm-count {
    ...
    color: var(--pr-forest); margin-left: 8px; vertical-align: middle; transition: all .2s;
}
...
<div class="pr-hero">
    <div class="pr-hero-inner">
        <div class="pr-hero-left">
            ...
            <div>
                <div class="pr-hero-title">{{ trans('global.edit') }} {{ trans('cruds.role.title_singular') }}</div>
        ...
        <div class="pr-hero-actions">
            <a href="{{ route('admin.roles.show', $role->id) }}" class="pr-btn-ghost">
...
<form method="POST" action="{{ route('admin.roles.update', [$role->id]) }}"
    enctype="multipart/form-data" id="editRoleForm">
    @method('PUT')
    @csrf
